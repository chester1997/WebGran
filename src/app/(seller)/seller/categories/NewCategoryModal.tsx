          ...
          <form id="new-category-form" onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select name="status" className="w-full bg-[#1A1A1E] border border-white/10 rounded-xl px-4 py-2.5 text-sm text-zinc-300 focus:outline-none focus:border-blue-500 appearance-none">
