    ...
    <div className="relative w-full h-[60vh] min-h-[400px] max-h-[600px] flex items-end justify-center">
      ...
      <div className="relative z-10 w-full px-4 pb-8 flex flex-col items-center text-center space-y-4">
        ...
        <div className="flex items-center gap-3 w-full justify-center mt-2">
          <Link href={href} className="flex-1 max-w-[140px] flex items-center justify-center gap-2 bg-white text-black font-semibold py-2 rounded-md hover:bg-zinc-200 transition-colors">
            <Play className="w-4 h-4 fill-black" />
            Acessar
          </Link>
          <Link href={href} className="flex-1 max-w-[140px] flex items-center justify-center gap-2 bg-zinc-800/80 text-white font-semibold py-2 rounded-md hover:bg-zinc-700/80 backdrop-blur-sm transition-colors">
